    ...
    <footer className="bg-primary text-primary-foreground">
      <div className="container py-12">
        ...
        <div className="mt-10 grid grid-cols-1 gap-10 md:grid-cols-2">
            ...
            <div id="localizacao" className="relative h-full min-h-[300px] w-full overflow-hidden rounded-lg border scroll-mt-20">
                <a href="https://maps.app.goo.gl/8vXc3rzdHzvLvdUJ7" target="_blank" rel="noopener noreferrer" className="absolute inset-0 z-10" aria-label="Ver no Google Maps"></a>
                <iframe
        ...
        <div className="mt-12 border-t border-primary-foreground/20 pt-6 text-center text-sm text-muted-foreground/80">
